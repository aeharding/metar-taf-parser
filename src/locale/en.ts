  ...
  Remark: {
    ...
    Hourly: {
      Maximum: {
        Minimum: {
          Temperature:
            "24-hour maximum temperature of {0}°C and 24-hour minimum temperature of {1}°C",
        },
    ...
    Snow: {
      ...
      Increasing: {
        Rapidly:
          "snow depth increase of {0} inches in the past hour with a total depth on the ground of {1} inches",
      },
    ...
    Tornadic: {
      Activity: {
        BegEnd:
          "{0} beginning at {1}:{2} ending at {3}:{4} {5} SM {6} of the station",
